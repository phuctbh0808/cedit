...
pub struct ReserveLiquidity {
    ...
    /// Reserve liquidity second oracle account
    pub second_oracle_pubkey: Pubkey,
...
impl ReserveLiquidity {
    ...
    pub fn new(params: NewReserveLiquidityParams) -> Self {
        Self {
            ...
            second_oracle_pubkey: params.second_oracle_pubkey,
            available_amount: 0,
...
pub struct NewReserveLiquidityParams {
    ...
    /// Reserve liquidity supply address
    pub supply_pubkey: Pubkey,
    /// Reserve liquidity main oracle account
    pub oracle_pubkey: Pubkey,
    /// Reserve liquidity second oracle account
    pub second_oracle_pubkey: Pubkey,
    /// Reserve liquidity market price in quote currency
...
impl Pack for Reserve {
    ...
    fn pack_into_slice(&self, output: &mut [u8]) {
        ...
        *liquidity_mint_decimals = self.liquidity.mint_decimals.to_le_bytes();
        ...
        liquidity_second_oracle_pubkey
            .copy_from_slice(self.liquidity.second_oracle_pubkey.as_ref());
