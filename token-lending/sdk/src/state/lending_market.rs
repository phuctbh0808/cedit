...
pub struct LendingMarket {
    ...
    /// Oracle (main) program id
    pub oracle_program_id: Pubkey,
    /// Oracle (second) program id
    pub second_oracle_program_id: Pubkey,
...
impl LendingMarket {
    ...
    pub fn init(&mut self, params: InitLendingMarketParams) {
        ...
        self.second_oracle_program_id = params.second_oracle_program_id;
...
impl Pack for LendingMarket {
    ...
    fn pack_into_slice(&self, output: &mut [u8]) {
        ...
        *bump_seed = self.bump_seed.to_le_bytes();
        ...
        second_oracle_program_id.copy_from_slice(self.second_oracle_program_id.as_ref());
    ...
    fn unpack_from_slice(input: &[u8]) -> Result<Self, ProgramError> {
        ...
        Ok(Self {
            ...
            second_oracle_program_id: Pubkey::new_from_array(*second_oracle_program_id),
