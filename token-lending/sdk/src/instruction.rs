...
pub enum LendingInstruction {
    ...
    ///   8. `[]` Oracle product account.
    ///   9. `[]` Oracle price account.
    ///             This will be used as the reserve liquidity oracle account.
    ///   10. `[]` Second oracle price feed account. used as a backup oracle
    ...
    ///   1. `[]` Oracle Reserve liquidity oracle account.
    ///             Must be the oracle price account specified at InitReserve.
    ///   2. `[]` Second oracle Reserve liquidity oracle account.
    ///             Must be the Second oracle price feed account specified at InitReserve.
    ...
    ///   10 `[]` price oracle account.
    ///   11 `[]` Second price feed oracle account.
...
pub fn init_lending_market(
    ...
    second_oracle_program_id: Pubkey,
) -> Instruction {
    Instruction {
        program_id,
        accounts: vec![
            ...
            AccountMeta::new_readonly(second_oracle_program_id, false),
        ],
...
pub fn init_reserve(
    ...
    oracle_product_pubkey: Pubkey,
    oracle_price_pubkey: Pubkey,
    second_oracle_feed_pubkey: Pubkey,
    lending_market_pubkey: Pubkey,
    ...
    let accounts = vec![
        ...
        AccountMeta::new_readonly(oracle_product_pubkey, false),
        AccountMeta::new_readonly(oracle_price_pubkey, false),
        AccountMeta::new_readonly(second_oracle_feed_pubkey, false),
...
pub fn refresh_reserve(
    ...
    reserve_liquidity_second_oracle_pubkey: Pubkey,
) -> Instruction {
    let accounts = vec![
        AccountMeta::new(reserve_pubkey, false),
        AccountMeta::new_readonly(reserve_liquidity_oracle_pubkey, false),
        AccountMeta::new_readonly(reserve_liquidity_second_oracle_pubkey, false),
    ];
    Instruction {
        program_id,
        accounts,
